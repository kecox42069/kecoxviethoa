...
! function($) {
    ...
    var transitions = typeof $("<div>").css({
        transition: "all"
    ...
    Swipeshow.prototype = {
        ...
        isStarted: function() {
            return this.cycler && this.cycler.isStarted()
        },
        isPaused: function() {
        ...
        _onpause: function() {
            ...
            this.$slideshow.addClass("paused").removeClass("running")
        },
        _onstart: function() {
            if (this.options.onstart) this.options.onstart();
            this.$slideshow.removeClass("paused").addClass("running")
        },
        ...
        _buildDots: function() {
            ...
            ss.$slides.each(function(i) {
                $dots.append($("<button class='dot-item' data-index='" + i + "'>" + "<span class='dot' data-number='" + (i + 1) + "'></span>" + "</button>"))
            });
        ...
        _bindKeys: function() {
            ...
            $(document).on("keyup" + tag, function(e) {
                if (e.keyCode == RIGHT) ss.next();
                else if (e.keyCode == LEFT) ss.previous()
            })
        },
    ...
    function setOffset($el, left, speed) {
        ...
        $el.addClass("gliding");
        if (typeof offsetTimer === "undefined") clearTimeout(offsetTimer);
    ...
    function getX(e) {
        if (e.originalEvent && e.originalEvent.touches && e.originalEvent.touches[0]) return e.originalEvent.touches[0].clientX;
